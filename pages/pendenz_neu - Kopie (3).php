...
?>
<style>
.pneu-wrap{max-width:1280px;margin:18px auto;padding:0 14px}
...
.pneu-grid{display:grid;grid-template-columns:1.2fr .9fr;gap:16px}
...
.pneu-btn{display:inline-flex;align-items:center;justify-content:center;gap:8px;padding:12px 16px;border-radius:12px;border:1px solid #2159a8;background:#2563eb;color:#fff;text-decoration:none;font-weight:700;cursor:pointer}
.pneu-btn.alt{background:#fff;color:#1f2937;border-color:#d7deea}
.pneu-box{padding:12px;border:1px dashed #cbd5e1;border-radius:12px;background:#fafcff}
...
@media (max-width: 980px){.pneu-grid{grid-template-columns:1fr}.pneu-fields{grid-template-columns:1fr}.pneu-switches{grid-template-columns:1fr}}
</style>
...
<div class="pneu-wrap">
    ...
    <form method="post" action="">
        ...
        <div class="pneu-card">
            <h2>3. Informationen &amp; Beschreibungen &amp; Notizen</h2>

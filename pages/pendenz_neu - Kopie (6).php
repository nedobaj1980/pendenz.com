...
<div class="pneu-wrap<?php echo $isEmbedded ? ' is-embedded' : ''; ?>">
    <div class="pneu-head">
        <div>
            <h1>Neue Pendenz</h1>
            <div class="pneu-note"><?php echo $isEmbedded ? 'Direkt eingebunden in die Pendenzenliste.' : 'Separates Formular. Tabelle und Dashboard bleiben unberührt.'; ?></div>
        </div>
...
<?php if (!$isEmbedded) { require_once __DIR__ . '/../includes/footer.php'; } ?>
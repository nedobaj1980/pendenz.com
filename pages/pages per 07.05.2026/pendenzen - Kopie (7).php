...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && postStr('form_action') === 'inline_update') {
                ...
                <div class="pendenzen-list">
                    ...
                    <div id="tableSettingsPanel" class="form-section"
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 8px 15px; margin-top: 10px;"
                            ...
                            <label><input type="checkbox" data-col="14"> Typ</label>
                        ...
                        <table id="pendenzenTable" class="pendenzen-table">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sort="text" data-label="Typ">Typ</th>
                                ...
                                <?php else: ?>
                                    <?php foreach ($recent as $row):
                                        ...
                                        <tr data-projekt="<?php echo h((string) $row['projekt_name']); ?>"
                                            ...
                                            <td data-label="Typ"><?php echo h($row['vorgangsart_name']); ?></td>
...
<script>
    ...
    (function () {
        ...
        const columnMap = {
            ...
            'vorgaenger_id': 13,
            'vorgangsart_name': 14,
            'bilder': 15, 'count_images': 15,
            'dokumente': 16, 'count_files': 16,
            'pdf': 17,
            'kurzbeschreibung': 18,
            'sichtbarkeit': 19,
            'erstellt_am': 20,
        ...
        function applyProfileColumns(colsString) {
            if (!colsString || !colsString.trim()) {
                reorderTableColumnsByOrder(defaultColumnOrder.concat([24]));
                setAllColumnsVisible(true);
                updateColumnVisibility(24, true);
                return;
            }
            ...
            if (!orderedIndices.includes(24)) {
                orderedIndices.push(24);
            }
            updateColumnVisibility(24, true);

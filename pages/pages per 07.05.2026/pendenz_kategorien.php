...
<div class="ov-wrap">
    <div class="ov-hero">
        <h1>🗂️ Vorlagen & Kategorien</h1>
        <p>Direkte Übersicht für Mieterkategorien, Vermieterkategorien, BKP und Vorgangsarten.</p>
        <div class="ov-toplinks">
            ...
            <a class="ov-topbtn" href="bkp_codes.php">BKP</a>
        </div>
    </div>

    <div class="ov-grid">
        <div class="ov-card">
            <div class="ov-head bg-mieter">🏠 Mieterkategorien</div>
            <div class="ov-body">
                <p>Kategorien und Kurzbeschreibungen für Mieter.</p>
                <a class="ov-btn bg-mieter" href="pendenz_kategorien_mieter.php">Öffnen</a>
            </div>
        </div>

        <div class="ov-card">
            <div class="ov-head bg-vermieter">🏢 Vermieterkategorien</div>
            <div class="ov-body">
                <p>Kategorien und Kurzbeschreibungen für Vermieter.</p>
                <a class="ov-btn bg-vermieter" href="pendenz_kategorien_vermieter.php">Öffnen</a>
            </div>
        </div>

        <div class="ov-card">
            <div class="ov-head bg-bkp">🧱 BKP</div>
            <div class="ov-body">
                <p>BKP-Codes, Titel und Kurzbeschreibungen für Unternehmer.</p>

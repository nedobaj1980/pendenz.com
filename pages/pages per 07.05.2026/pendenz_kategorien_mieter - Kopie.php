...
<div class="vm-wrap">
    <div class="vm-top">
        <div>
            <div class="vm-title">🏠 Mietervorlagen</div>
            <div class="vm-sub">Titel Kategorie und Kurzbeschreibung projekt- und objektspezifisch pflegen.</div>
        </div>
        <div class="vm-links">
    ...
    <div class="vm-card">
        <?php if (!$kategorien): ?>
            <div class="vm-empty">Noch keine Mietervorlagen vorhanden.</div>
        <?php else: ?>

...
<div class="container">
    <header class="hero hero-teal">
        ...
        <div style="margin-top: 15px; display:flex; gap:10px; flex-wrap:wrap;">
            <a href="<?= e(url('tools/mietkontrolle/index.php')) ?>" class="btn" style="background:#10b981; color:#fff; text-decoration:none; padding:8px 16px; border-radius:8px; font-weight:700; display:inline-flex; align-items:center; gap:6px;">💰 Mietkontrolle (Soll/Ist)</a>
            <a href="<?= e(url('tools/konto_verwaltung/index.php')) ?>" class="btn" style="background:#3b82f6; color:#fff; text-decoration:none; padding:8px 16px; border-radius:8px; font-weight:700; display:inline-flex; align-items:center; gap:6px;">🏦 Bankkonto & CSV-Import</a>
            <a href="<?= e(url('pages/mieterspiegel.php')) ?>" class="btn" style="background:#64748b; color:#fff; text-decoration:none; padding:8px 16px; border-radius:8px; font-weight:700; display:inline-flex; align-items:center; gap:6px;">📋 Mieterspiegel</a>
        </div>
    </header>

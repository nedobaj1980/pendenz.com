...
$imgs=[]; $files=[];
$res = $mysqli->query("SELECT * FROM pendenz_dateien WHERE pendenz_id={$id} ORDER BY COALESCE(is_cover,0) DESC, CASE WHEN titel='Plan-Ausschnitt' THEN 1 ELSE 0 END ASC, id ASC");
